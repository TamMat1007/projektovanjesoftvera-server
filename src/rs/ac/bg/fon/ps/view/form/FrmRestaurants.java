 ...
 * @author Tamara
 */
public class FrmRestaurants extends javax.swing.JDialog {

    /**
     * Creates new form FrmRestaurants
     */
    public FrmRestaurants(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRestaurants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRestaurants dialog = new FrmRestaurants(new javax.swing.JFrame(), true);
