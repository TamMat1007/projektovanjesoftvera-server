...
public class RestaurantsTableModel extends AbstractTableModel{
    ...
    private final String[] columnNames= {"ID","Name","Address", "Phone","Open Working", "Closed working","Open weekend","CLOSED weekend","City"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 5: return restaurant.getClosedWorkingDay();
            case 6: return restaurant.getOpenWeekend();
            case 7: return restaurant.getClosedWeekend();
